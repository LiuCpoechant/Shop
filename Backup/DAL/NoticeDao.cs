...
namespace Shop.DAL
{
	...
	public partial class NoticeDao
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("adminid", "t_notice"); 
		}
		...
		public bool Exists(int adminid,int noid)
		{
			...
			strSql.Append(" where adminid=@adminid and noid=@noid ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select noid,adminid,notitle,nocontent,notime ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" noid,adminid,notitle,nocontent,notime ");
			strSql.Append(" FROM t_notice ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
